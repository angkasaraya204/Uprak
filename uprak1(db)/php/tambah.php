                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="col-sm">
                            ...
                            <input type="text" class="form-control" name="gambar" placeholder="Masukan Link">
                            </div>
                        </div>
                        <div class="col-sm">
                        <div class="mb-3">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="unggul"></textarea>
                                    </div>
                                </div>
                            </div>
                            </div>
