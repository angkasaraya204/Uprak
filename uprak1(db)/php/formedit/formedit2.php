...
<body>
    ...
    <section id="tabel-list">
        ...
        <?php
            ...
            ?>
                    <div class="container">
                        <form action="../formedit/edit2.php" method="POST">
                        <div class="row">
                        <div class="col-sm">
                        <div class="mb-3">
                            <label class="form-label">Quantity:</label>
                            <input type="number" style="width: 6%;" class="form-control" name="qty" value="<?php echo $row["quantity"];?>">
                            <input type="submit" class="btn btn-success mt-2" name="simpan" value="simpan">
                    </div>
                        <div class="col-sm">
                        <div class="mb-3">
                            <input type="hidden"  class="form-control" value="<?php echo $row["nma_produk"];?>" name="nama">
                            </div>
                        </div>
                </form>
                    </div>
