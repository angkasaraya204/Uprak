                ...
                ?>
                    <div class="col-sm">
                            ...
                            <input class="form-control" type="hidden" name="id"
                                        value="<?php echo $row["id"];?>" aria-label="default input example">
                                <img src="<?php echo $row["gambar"];?>" class="card-img-top">

                                <div class="card-body text-center">
                                    <a href="produk.php?page=product&id=<?=$row['id']?>" class="card-title"><?php echo $row["nma_produk"];?></a>
                                    <p class="card-text">Harga: Rp. <?php echo number_format($row["hrga_produk"] * 0.5, 0,',','.');?></p>
                                    <p class="card-text"><small class="text-muted">Terakhir ditambahkan: </br> <?php echo $row["latestup"];?></small></p>

                                    <input class="form-control" type="hidden" name="qty"
                                        value="<?php echo $row["quantity"];?>" aria-label="default input example">
                                    <input class="form-control" type="hidden" name="desk"
                                        value="<?php echo $row["desk"];?>" aria-label="default input example">
                                    <input class="form-control" type="hidden" name="unggul"
                                        value="<?php echo $row["unggul"];?>" aria-label="default input example">
